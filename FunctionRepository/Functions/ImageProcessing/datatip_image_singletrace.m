function output_txt = datatip_image_singletrace(obj,event_obj)
...
for i=cellsinimage
    text(double(int16(allxorg(i,frame))-miny)*imagescale,double(int16(allyorg(i,frame))-minx)*imagescale,num2str(i),'horizontalalignment','center','color','k','fontsize',10,'fontweight','bold');
end
