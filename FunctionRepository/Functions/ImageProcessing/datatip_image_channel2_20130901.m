...
global rawdir maskdir gatedtraces plotfignum immunoframe
...
allx=gatedtraces(:,frame,1); ally=gatedtraces(:,frame,2);
...
raw=single(imread([rawdir,'TexasRed_',framestring,'.tif']));
%%%%% crop image %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
