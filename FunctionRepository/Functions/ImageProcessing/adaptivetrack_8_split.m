...
masschangethreshold=0.25; % was all 0.2 before
areachangethreshold=0.25; % was 0.2 before
if H2BvsNLS==1
    daughtermin=-0.55;
    daughtermax=-0.45;
elseif H2BvsNLS==2
...
shortmerge=(curframe-tracking(:,4))<=12; %was 5 before
...
%     if abs(xprev(p)-529)<20 && abs(yprev(p)-1307)<20 && tf==15
%         keyboard;
%     end
