...
for row = 1:numrows
    for site = 1:numsites
        shot=[num2str(rows(row)),'_', num2str(cols(1)), '_', num2str(sites(site))];
...
%%% gate miscellaneous %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
traces3=tracedata(:,:,3); % Area is 3, Mass(total h2b intensity) is 4
% traces2 = tracedata(:,:,7);
% traces3 = tracedata(:,:,8);
...
[numtraces,~] = size(traces1);
find(alltraces1(:,1)==0,1,'first');
    alltraces1 = [alltraces1; traces1];
    alltraces2 = [alltraces2;traces2];
    alltraces3 = [alltraces3;traces3];
    alltracestats = [alltracestats;tracestats];
    allIDs = [allIDs; IDs];
    allwellID = [allwellID;wellID];
    allmotherstats = [allmotherstats; motherstats];
    allmarkedmitosis = [allmarkedmitosis; markedmitosis];
