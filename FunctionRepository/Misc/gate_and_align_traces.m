...
motheroption=1; %0:no gating 1:mothers (traces that end in mitosis) 2:no mothers (traces that don't end in mitosis)
...
minthresh=40; %threshold below which min of each trace must be %50
