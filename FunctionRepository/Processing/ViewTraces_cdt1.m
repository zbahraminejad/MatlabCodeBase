...
badtraces=badstarttime | badlengths | badtraces1 | badtraces2;
...
%         subaxis(4,6,mod(counter-1,24)+1,'ML',0.02,'MR',0.01,'MT',0.03,'MB',0.03,'SH',0.02); %5x4
        ...
        subaxis(2,3,mod(counter-1,6)+1,'ML',0.02,'MR',0.01,'MT',0.03,'MB',0.03,'SH',0.04);
    end
    set(gcf,'color','w');
