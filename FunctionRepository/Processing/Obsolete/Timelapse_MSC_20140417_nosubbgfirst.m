...
tracedata=ones(maxcellnum,totalframes,6+ringcalc)*NaN; %default 7
...
for i=firstgoodindex:totalframes
    ...
    timeframe=tic;
    %%% read images %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    raw1=single(imread([rawdir,name1,num2str(f),'.tif'])); %raw1=raw1./sc1;
...
%     numthresh=0.85*numcells;
    ...
    if maxcellnum-max(cellid)<3000
        tempdata=ones(blocksize,totalframes,6+ringcalc)*NaN; %default 7
