function Immunostain_2_ManualShadingCorrection(row,col,site)
row=2;col=3;site=1;
%%% file paths %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
iqrmult=6; %was 4 before 2014/4/17
...
extractmask=bwmorph(nuc_mask,'remove');
tempframe=imadjust(mat2gray(real1));
