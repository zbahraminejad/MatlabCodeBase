...
blobthreshold=-0.02; %MCF-10A:-0.03 YT+:-0.03
timetotal=tic;
%%% shading correction %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load([shadingpath,'DAPI','.mat'],'shadingcorrection'); sc1=shadingcorrection;
load([shadingpath,'TxRed','.mat'],'shadingcorrection'); sc2=shadingcorrection;
load([shadingpath,'Cy5','.mat'],'shadingcorrection'); sc3=shadingcorrection;
%%% load images %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
