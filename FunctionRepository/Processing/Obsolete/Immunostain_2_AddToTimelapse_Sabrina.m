...
areaonly=0; %0:mass conservation 1:Hoechst stain corrupts H2B-CFP, so use area conservation
...
IFdata=[nuc_center(:,1),nuc_center(:,2),nuc_area,nuc_mass,sig2,sig2ring,IFsig1]; %Sabrina
