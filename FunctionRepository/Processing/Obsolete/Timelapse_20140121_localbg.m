...
datadir=([projectpath,experimentpath,'Data_20140121_alllocal\']);
...
for i=firstgoodindex:totalframes
    ...
    %%% subtract background %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    nanmask=imdilate(foreground,strel('disk',nucr)); %make sure to block foreground
    ...
    bg2=centroidbackground(nanmask,nuc_center_org,raw2,nucr,20,0.25,10);
    bg3=centroidbackground(nanmask,nuc_center_org,raw3,nucr,10,0.25,50);
