...
SF=1;EF=200; %Sabrina20x:208 Steve20x:219 Steve10x:111 Steve&Sabrina: 240
DAroot = '_CFP_';  %H2B  Pilot:'mRFP1' Steve20x:'ECFP' Steve10x:'CFP' Steve&Sabrina:'mRFP1'
REroot = '_Cy5_';  %hDHB Pilot:'EYFP' Steve20x:'EYFP' Steve10x:'EYFP' Steve&Sabrina:'YFP'
CEroot = '_FRET_';%gemenin/cdt1 Pilot:'ECFP' Steve20x:'mRFP1' Steve10x:'mRFP1' Steve&Sabrina:'CFP'
DAname = '_nuc_';
REname = '_DHB_';
...
for f=SF:EF
    ...
    DAwritefile=[shot,DAname,num2str(g),'.tif'];  %f-->g if using patch
    REwritefile=[shot,REname,num2str(g),'.tif'];  %f-->g if using patch
    CEwritefile=[shot,CEname,num2str(g),'.tif'];  %f-->g if using patch
