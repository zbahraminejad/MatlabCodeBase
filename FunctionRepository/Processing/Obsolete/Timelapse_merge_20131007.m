...
%%% setup %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SF=1;EF=5; %0715=230 0719=216 0905=220 0920=226 SS1211=230 SS0222=149
nucr=8; %BJ5-bin1=8
...
for i=firstgoodindex:totalframes
    ...
    %nuc_blur=imfilter(nuc_raw,fspecial('disk',floor(nucr/2)),'symmetric');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if i==firstgoodindex
        tracking=ones(numcells,6)*NaN;  %[mothercellid,mergeongoing,cell#1,cell#2,startframe,endframe]
    else
        %%% calculate jitter %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        [tracedatacell,curdata,tracking,nuc_label]=adaptivetrack_merge(lastgoodframe,f,tracedatacell,curdata,tracking,nuc_raw,nuc_label,nucr,jitters(i,:));
        numcells=size(curdata,1);
