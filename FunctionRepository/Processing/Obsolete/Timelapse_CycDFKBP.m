...
shotname=[num2str(row),num2str(col),'_site',num2str(site)];
shot=[num2str(row),'_',num2str(col),'_',num2str(site)];
datadir=([projectpath,experimentpath,'Data\']);
rawdir=[imagepath,experimentpath,'Raw\',shotdir,'\'];
%%% setup %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SF=1;EF=208; %0715=230 0719=216 0905=220 JY-CycD-DHFR=208
nucr=4; %BJ5-bin2=4
jitterwindow=8*nucr;
ringcalc=1; %set to zero if ring is unneeded
nucname=[shotname,'_ECFP_']; %nuc
YFPname=[shotname,'_YFP_']; %DHB
RFPname=[shotname,'_Texas Red_']; %p21
