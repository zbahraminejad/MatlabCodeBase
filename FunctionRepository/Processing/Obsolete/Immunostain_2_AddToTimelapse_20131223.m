...
areaonly=1; %0:mass conservation 1:Hoechst stain corrupts H2B-CFP, so use area conservation
...
IFbg1=centroidbackground(nuc_mask_withborders,nuc_center(cellid,:),IFraw1,nucr,3,0.25,50);
