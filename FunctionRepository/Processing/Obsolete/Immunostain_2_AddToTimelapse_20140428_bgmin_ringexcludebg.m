...
IFbg1=ones(size(nuc_mask))*IFc1;
IFbg2=ones(size(nuc_mask))*IFc2;
%IFbg3=ones(size(nuc_mask))*IFc3;
real1=raw1-bg1;
real2=raw2-bg2;
...
for cc=cellid'
    ...
    sig2ringall=real2(ring_info(cc).PixelIdxList);
     sig2ring_75th(cc)=prctile(sig2ringall,75); %previously mean
     sig2ring_50th(cc)=median(sig2ringall);
     sig2ring_nobg(cc)=median(sig2ringall(sig2ringall>75));
