...
if separatedirectories
    ...
    rawdir = [imagepath,experimentpath,'Raw\5_4_1_'];
...
sc1=shadingcorrection(empty1,block1);
%shadingcorrection=imfilter(single(imread('3_4_1_DAPI_pink.tif')),fspecial('disk',nucr),'symmetric');
%imagesc(shadingcorrection);colorbar;saveas(gcf,'H:\Downloads\Fig.jpg');
%%% load images %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
