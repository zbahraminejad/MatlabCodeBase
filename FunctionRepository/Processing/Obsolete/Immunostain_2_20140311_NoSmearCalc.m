...
nuc_label=bwlabel(nuc_mask_features);
...
sig2ring=nanvec; sig3ring=nanvec;
for cc=1:numcells
...
% bg4=centroidbackground(nuc_mask_withborder,nuc_center,raw4,nucr,10,0.25,10); %AllRows:50
sig2=sig2-bg2;
...
%%% store data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
IFdata=[nuc_center(:,1),nuc_center(:,2),nuc_area,nuc_mass,sig2,sig2_mean,sig2_max];
