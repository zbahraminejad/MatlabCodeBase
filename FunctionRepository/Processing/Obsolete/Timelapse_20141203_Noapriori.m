...
row=4;col=4;site=1; %3_5_1 5_6_1
%%% set paths %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
experimentpath='20140808 NLSpipCy2\20141015 GemVen mKatePIP comparison\';
...
debrisarea=100;
boulderarea=1200; %MCF-10A: H2B:20 NLS:10
...
%     nuc_mask=secondthresh(raw1,blurradius,nuc_mask,boulderarea);
    ...
    compression=4; sampleprctile=50;
    real1=bgsubmasked_global_2(raw1,nanmask,11,compression,sampleprctile);
    real2=bgsubmasked_global_2(raw2,nanmaskcyto,1,compression,sampleprctile);
    real3=bgsubmasked_global_2(raw3,nanmaskcyto,1,compression,sampleprctile);
    %%% extract features %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
