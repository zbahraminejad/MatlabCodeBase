...
DAPI_sig=nanvec; IF_sig_med=nanvec; IF_sig_max=nanvec; IF_sig_mean=nanvec;
for cc=cellid'
    YFP_sig(cc)=median(YFP_raw(nuc_info(cc).PixelIdxList));
    RFP_sig(cc)=mean(RFP_raw(nuc_info(cc).PixelIdxList));
    ...
    IF_sig_max(cc)=max(IF_raw(nuc_info(cc).PixelIdxList));
    IF_sig_mean(cc)=mean(IF_raw(nuc_info(cc).PixelIdxList));
end
%%% subtract background %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
IF_sig_max(cellid)=IF_sig_max(cellid)-IF_bg;
IF_sig_mean(cellid)=IF_sig_mean(cellid)-IF_bg;
...
%%% store data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
IFdata=[nuc_center(:,1),nuc_center(:,2),nuc_area,nuc_mass,YFP_sig,RFP_sig,YFP_sigring,DAPI_sig,IF_sig_med,IF_sig_max,IF_sig_mean];
