...
SF=1;EF=234;
nucr=8; %calculate avg nuclear radius with Measure_avgnucrad.m
nucname = 'CFP_'; %nuc
...
blobthreshold=-0.03;  %default 10xbin1=-0.02. 10xbin2=-0.03. Try +/-0.01.
timetotal=tic;
...
for i=firstgoodindex:totalframes
    ...
    if i==firstgoodindex
        ...
        [jitx,jity]=getjitter_loners(nuc_center,tracedatacell{lastgoodframe}(:,1:2),nucr,dims);
