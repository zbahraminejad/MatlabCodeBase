...
%%% setup %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SF=161;EF=225; %0715=230 0719=216 0905=220 0920=226 JY0612=208 SS1211=230 SS0222=149 20140208_p21dCy1dK=229
moviebin=1;
if moviebin==1
    nucr=12;
...
tracedata=ones(maxcellnum,totalframes,4+ringcalc)*NaN; %default 7
...
for i=firstgoodindex:totalframes
    ...
    blurthreshhigh=1.08*mednuc;  %H2B:1.1 NLS:1.08
    blurthreshlow=0.95*mednuc;   %H2B:0.8 NLS:0.95
    numthresh=0.85*numcells;     %H2B:0.5 NLS:0.85
...
%     end
    ...
    if ringcalc==1
        ...
        tracedata(cellid,i,:)=[nuc_center(:,1),nuc_center(:,2),nuc_area,nuc_mass];
    end
    if maxcellnum-max(cellid)<3000
        tempdata=ones(blocksize,totalframes,4+ringcalc)*NaN; %default 7
