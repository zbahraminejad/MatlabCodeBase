...
%%% setup %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SF=1;EF=50; %0715=230 0719=216 0905=220 0920=226 JY0612=208 SS1211=230 SS0222=149
moviebin=1;
if moviebin==1
    nucr=12;
...
adjustframe=[11 12 41 42]; %Heewon 7_10_1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
frames=SF:EF;
...
for i=firstgoodindex:totalframes
    ...
    %%% subtract background %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    nanmask=imdilate(nuc_mask_withborders,strel('disk',nucr)); %make sure to block foreground
    ...
    %%% subtract background %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    nuc_center_org=nuc_center-ones(numlivecells,1)*jitters(i,:);
    bg2=centroidbackground(nanmask,nuc_center_org,raw2,nucr,10,0.25,10);
    bg3=centroidbackground(nanmask,nuc_center_org,raw3,nucr,2,0.25,50);
    %bg4=centroidbackground(nanmask,nuc_center_org,raw3,nucr,3,0.25,50);
    sig2=sig2-bg2;
    sig3=sig3-bg3;
    %sig4=sig4-bg4;
    if ringcalc==1
