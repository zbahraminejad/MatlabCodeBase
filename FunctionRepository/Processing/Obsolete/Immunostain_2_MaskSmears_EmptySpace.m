...
datadir = ([projectpath,experimentpath,'Data_Median\']);
...
onesmat=ones(height,width);
bg1=median(blur1(empty1))*onesmat;
bg2=median(blur2(empty2))*onesmat;
bg3=median(blur3(empty3))*onesmat;
bg4=median(blur4(empty4))*onesmat;
%%% remove nucleoli %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
