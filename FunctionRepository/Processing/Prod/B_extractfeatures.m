function B_extractfeatures_prod(row,col,site)
timetotal=tic;
...
REname = '_hDHB_';
CEname = '_gem_';  %Pilot:'cdt1' Steve20x:'geminin' Steve10x:'geminin' Steve&Sabrina:'cdt1'
...
for f=SF:EF
    ...
    wellsss{f-initF+1}=[XX,YY,DD,AC,RR,CCC,ring]; %x,y,nuc intensity, nuc area, nuc hDHB, nuc cdt1, ring hDHB
    toc(timeframe)
end
