...
SF=1;EF=240; %Sabrina20x:208 Steve20x:219 Steve10x:111 Steve&Sabrina: 240
%nucr=8; %MCF10A/10x:8 MCF10A/20x:16 HS68andHeLa/10x:9
DAroot = '_mRFP1_';  %H2B  Pilot:'mRFP1' Steve20x:'ECFP' Steve10x:'CFP' Steve&Sabrina:'mRFP1'
REroot = '_YFP_';  %hDHB Pilot:'EYFP' Steve20x:'EYFP' Steve10x:'EYFP' Steve&Sabrina:'YFP'
CEroot = '_CFP_';%gemenin/cdt1 Pilot:'ECFP' Steve20x:'mRFP1' Steve10x:'mRFP1' Steve&Sabrina:'CFP'
DAname = '_nuc_';
