function [signals,badtraces]=gate_pparg_MeanIntensity(tracedata,tracestats,noisethresh,sigchannel,minthreshold,minpos,maxthreshold,maxpos)
...
signals = tracedata(:,:,sigchannel); %return raw signal (not smoothened)