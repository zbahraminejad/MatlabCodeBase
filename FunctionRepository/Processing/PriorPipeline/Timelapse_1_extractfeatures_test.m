...
celldata=cell(totalframes,1);  %change later to tracedata and cell(totalframes)
...
for i=1:totalframes
    ...
    %%% store data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    celldata{i}=[XX,YY,nuc_intensity,nuc_area,YFPnuc,RFPnuc,YFPring];
...
[x,y]=calculatejitters_cellmatch(celldata,badframes,height,width);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
